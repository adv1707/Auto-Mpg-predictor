...
- Did some statistics as most of the columns were left skewed and also some were right skewed so used FunctionTransformers to try to make it normal
...
- As a bonus I also tried to make a CLI using OOP that is in CLI.py
